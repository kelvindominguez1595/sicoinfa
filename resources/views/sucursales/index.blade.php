...
@section('js')
    ...
    <script src="{{ asset('js/pages/sucursales.js') }}"></script>
@endsection
    ...
    <div class="row mb-2">
                ...
                <div class="card-body">
                    <form action="" method="get" id="frmsearch">
                        <div class="mb-3 d-flex justify-content-center">
                            <button class="btn btn-primary btn-sm" type="button" id="btnresetall" onclick="$(location).attr('href','sucursales');">Mostrar Todo</button>
                        </div>
        ...
        <div class="col-xs-12 co-sm-12 col-md-9 col-lg-9 col-xl-9">
            <div class="card mb-4 border-primary">
                ...
                <div class="card-body">
                    @include('sucursales.partials.nuevo')
