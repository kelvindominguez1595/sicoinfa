...
@section('js')
    <script src="{{ asset('js/pages/medidas.js') }}"></script>
@endsection

@section('content')
    @include('medidas.modals.modal')
                ...
                <div class="card-body">
                    <form action="{{ route('medidas.index')}}" method="get">
                        ...
                        <div class="mb-3 d-flex justify-content-center">
                            <button class="btn btn-primary btn-sm" type="button" id="btnresetall" onclick="$(location).attr('href','medidas');">Mostrar Todo</button>
                        </div>
                        <div class="row">

                            <div class="col-12  mb-2">
                                <label for="nombre" class="form-label fw-bold">Unidad de Medida</label>
                                <input type="text" class="form-control" id="name" name="name" autocomplete="false" value="{{ $name }}" placeholder="Unidad de Medida">
                            </div>
