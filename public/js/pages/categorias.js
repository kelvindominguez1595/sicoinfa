$(document).ready(function (){
    ...
    $(document).on('click', '#btneditar', function (){
        var id = $(this).val();
        $.get('/categorias/'+ id +'/edit', function (res) {
            // mostrar el modal
            $("#modaldata").modal("show");
    ...
    $(document).on('click', '#btnborrar', function (){
        var id = $(this).val();
        $.get('/categorias/'+ id , function (res) {
            // mostrar el modal
            ...
            if(res[0].marcacount > 0) {
                ...
                html += '<ol>';
                html += '<li>Actualizar la categoría para que afecte a los registros.</li>';
                html += '<li>Cambiar los productos a otra categoría</li>';
                html += '</ol>';
                html += '</p>';
                html += '</div>';
